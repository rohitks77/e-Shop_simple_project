...
<body>
    ...
    <div id="splash-screen">
        <div class="splash-content">
            <img src="e_shop.png" alt="images/e-Shop Logo" width="300px" class="splash-image">
    ...
    <section class="content_home" id="home">
        ...
        <div class="right_home">
            <img src="images/home_page_.png" alt="">
        </div>
    </section>
    <!-- home pages end here -->
    <h1 style="text-align: center;" id="products">Products</h1>
